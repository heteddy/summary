...
> Input: [CLS] Query [SEP] Document [SEP]→ Transformer → 分类头或打分回归头 → 得分
...
# Bi-Encoder vs Cross-Encoder 对比表
...
[https://huggingface.co/cross-encoder/ms-marco-MiniLM-L12-v2](https://huggingface.co/cross-encoder/ms-marco-MiniLM-L12-v2)