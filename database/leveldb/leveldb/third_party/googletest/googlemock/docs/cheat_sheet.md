...
To customize the default action for functions with return type *`T`* *T*:
...
mock method is called). See [here](../../../../../../../leveldb/leveldb/third_party/googletest/googlemock/docs/cook_book.md#UseOnCall#UseOnCall) for a more detailed  
discussion.
...
[here](../../../../../../../leveldb/leveldb/third_party/googletest/googletest/docs/advanced.md#regular-expression-syntax#regular-expression-syntax). All of  
...
- These matchers can also match:
  ...
  2. an array passed as a pointer and a count (e.g. in `Bar(const T* buffer,  
     int len)` -- see [Multi-argument Matchers](../../../../../../../leveldb/leveldb/third_party/googletest/googlemock/docs/#MultiArgMatchers#MultiArgMatchers)).
...
| `SafeMatcherCast<T>(m)` | [safely casts](../../../../../../../leveldb/leveldb/third_party/googletest/googlemock/docs/cook_book.md#casting-matchers#casting-matchers) matcher `m` to type `Matcher<T>`. |
...
See this [recipe](../../../../../../../leveldb/leveldb/third_party/googletest/googlemock/docs/cook_book.md#using-check-points#using-check-points) for one application of it.
