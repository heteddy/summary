...
[Assertion Placement section](primer.md#assertion-placement) for more information.
...
>    [this](primer.md#the-compiler-complains-no-matching-function-to-call-when-i-use-assert-pred-how-do-i-fix-it)  
...
[gMock](primer.md) comes with a library of matchers for validating  
...
Read this  
[recipe](primer.md#using-matchers-in-googletest-assertions)  
in the gMock Cookbook for more details.

gMock has a rich set of matchers. You can do many things googletest cannot do  
alone with them. For a list of matchers gMock provides, read  
[this](primer.md#using-matchers). It's easy to write  
your [own matchers](primer.md#NewMatchers) too.
...
(Please read the [previous](primer.md#asserting-using-gmock-matchers) section first if  
you haven't.)

You can use the gMock  
[string matchers](primer.md#string-matchers) with  
...
[constructor/destructor vs. ](primer.md#CtorVsSetUp)[SetUp](primer.md#CtorVsSetUp)[SetUp](primer.md#CtorVsSetUp)[/](primer.md#CtorVsSetUp)[TearDown](primer.md#CtorVsSetUp)[TearDown](primer.md#CtorVsSetUp)
...
code, see [Exception Assertions](primer.md#ExceptionAssertions).
...
a signal.
> 
> This means that if *`statement`* *statement* terminates the process with a 0 exit code, it  
...
[Death Tests And Threads](primer.md#death-tests-and-threads) section below explains why.
...
[XML output](primer.md#generating-an-xml-report) if you specify one. For example, the  
test
...
> - *`key`* *key* must be a valid XML attribute name, and cannot conflict with the  
...
3. In the same test fixture class, define a `static void SetUpTestSuite()`  
   function (remember not to spell it as **`SetupTestSuite`** **SetupTestSuite** with a small  
...
You can use these names in [--gtest_filter](primer.md#running-a-subset-of-the-tests)[--gtest_filter](primer.md#running-a-subset-of-the-tests).
...
You can see  and  for more examples.
...
[should not contain underscores](primer.md#why-should-test-suite-names-and-test-names-not-contain-underscore)
...
See  for an example of a failure-raising listener.
...
[global set-up/tear-down](primer.md#global-set-up-and-tear-down) code, it will be  
...
you identify slow tests. The report is also used by the [http://unittest](http://unittest)  
...
running the tests.    "message": "Value of: add(1, 1)\n  Actual: 3\nExpected: 2",
              "type": ""
            },
            {
              "message": "Value of: add(1, -1)\n  Actual: 1\nExpected: 0",
