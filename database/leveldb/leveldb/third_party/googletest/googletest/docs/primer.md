...
| :----------------------------------------------------------------------------------- | :--------------------------------- | :---------------------------------- |
| Exercise a particular program path with specific input values and verify the results | [TEST()](advanced.md#simple-tests) |                                     |
...
[documentation](advanced.md#teaching-gmock-how-to-print-your-values).
...
typed, while `NULL` is not. See the [FAQ](advanced.md) for more details.
...
3. If necessary, write a default constructor or `SetUp()` function to prepare  
   ...
   **`Setup()`** **Setup()** with a small `u` - Use `override` in C++11 to make sure you  
   spelled it correctly.
4. If necessary, write a destructor or `TearDown()` function to release any  
   resources you allocated in `SetUp()` . To learn when you should use the  
   constructor/destructor and when you should use `SetUp()/TearDown()`, read  
   the [FAQ](advanced.md#CtorVsSetUp).
...
- Google Test is designed to be thread-safe. The implementation is thread-safe  
  ...
  *unsafe* to use Google Test assertions from two threads concurrently on  
  ...
  `gtest-port.h` for your platform.ions is too much work? We  
agree with you completely, and that's why Google Test provides a basic  
implementation of main(). If it fits your needs, then just link your test with  
the `gtest_main` library and you are good to go.
